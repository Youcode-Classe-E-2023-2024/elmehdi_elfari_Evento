...
<body class="text-gray-800 font-inter">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <!-- Content -->
        <div class="bg-yellow-100 text-yellow-800 pl-4 pr-10 py-4 rounded relative mb-4" role="alert">
            @if (session('success'))
                <div class="inline-block max-sm:mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-yellow-500 inline mr-4"
                        viewBox="0 0 128 128">
                        <!-- SVG path for success alert -->
                    </svg>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <!-- Display three cards here -->
            <div class="bg-green-100 text-green-800 pl-4 pr-10 py-4 rounded relative" role="alert">
                <strong class="font-bold text-base">Success Card</strong>
            </div>

            <div class="bg-red-100 text-red-800 pl-4 pr-10 py-4 rounded relative" role="alert">
                <strong class="font-bold text-base">Error Card</strong>
            </div>

            <div class="bg-yellow-100 text-yellow-800 pl-4 pr-10 py-4 rounded relative" role="alert">
                <strong class="font-bold text-base">Warning Card</strong>
            </div>
        </div>
