...
<body>
    @include('layouts.nav')
    <div class="max-w-6xl mx-auto mt-8 flex flex-wrap justify-around">

        @foreach ($validatedEvents as $event)
            <div
                class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700 mb-6">
                <a href="#">
                    <img class="rounded-t-lg" src="{{ asset('storage/') . '/' . $event->image }}"
                        alt="{{ $event->title }}">
                </a>
                <div class="p-5">
                    <a href="#">
